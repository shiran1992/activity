...
/**
 * Servlet implementation class ActivityModify
 */
public class ActivityModify extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		res = activityService.modifyActivity(name, location, start_time, end_time, endsign_time, max_people, free, pay_money, image_top, image_middle, image_under, is_recommend, is_hot, teacherid,id,address);
